            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group ">
                            {!! Form::label('homepage_expire', null, ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-5">
                                {!! Form::input('date', 'homepage_expire', null, ['class' => 'form-control', 'id' => 'homepage_expire']) !!}
                            </div>
                        </div>
            ...
            <div class="panel panel-primary" data-collapsed="1">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-horizontal form-groups-bordered">
                        ...
                        <div class="form-group">
                            {!! Form::label('pitch'.$pitch->id, $pitch->name, ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-5">
                                {!! Form::text('pitch['.$pitch->id.']', null, ['class' => 'form-control', 'id' => 'pitch'.$pitch->id]) !!}
                            </div>
                        </div>
